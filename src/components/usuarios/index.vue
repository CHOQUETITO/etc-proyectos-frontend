...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Fecha de Nacimiento', value: 'fechaNacimiento', class: 'teal darken-4 white--text' },
      { text: 'Correo Electrónico', value: 'correoElectronico', class: 'teal darken-4 white--text' },
